...
import com.linbo.feature.window.component.JLinePanel;
import com.linbo.feature.window.component.JListItem;
import com.linbo.feature.window.enums.CloseAction;
import com.linbo.feature.window.layout.ListLayout;
import com.linbo.feature.window.service.WelcomeService;
...
public class WelcomeWindow extends AbstractWindow <WelcomeService>{
    public WelcomeWindow() {
        super("APP", new Dimension(500, 500), false, WelcomeService.class);
...
//        this.initGlobalFont();
    ...
    protected void initWindowContent() {
        ...
        this.addComponent("welcome.panel.top", new JPanel(), BorderLayout.NORTH, panel -> {
            ...
            this.addComponent(panel, "welcome.panel.top.top",
                    new JLinePanel(true), BorderLayout.EAST, this::initContentTop);
            //下半部分是搜索框，这个就简单，价格搜索框就完事了
            this.addComponent(panel, "welcome.panel.top.bottom",
                    new JPanel(), BorderLayout.LINE_START, this::initContentBottom);
        });
    ...
    private void initContentTop(JLinePanel top){
        top.setPreferredSize(new Dimension(220, 25));
...
//        });
    ...
    private void initContentBottom(JPanel bottom){
        this.addComponent(bottom, "welcome.field.search", new JTextField(),field -> {
            field.setPreferredSize(new Dimension(250, 25));
            field.addKeyListener(service.refreshListAdapter());
        });
    }
